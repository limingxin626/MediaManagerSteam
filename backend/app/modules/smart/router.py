...
from app.modules.media.schemas import MediaResponse, MediaCursorResponse
from app.modules.smart import clip_service, service as smart_tag_service
from app.modules.smart.schemas import ApplyRequest, RebuildRequest, SuggestRequest, TagSuggestion
...
def similar_media(
    ...
    try:
        ...
        raise HTTPException(status_code=404, detail=str(e))
    ordered = smart_tag_service.fetch_media_in_order(db, scored)
